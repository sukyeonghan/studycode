...
//	}
	...
	public void print(Person p) { //p에는 person을 상속받은 모든 객체가 들어올 수 있음(p,e,s) 뭐가 들어올지 모르니까 분리해서 작성해야함.
		if(p instanceof Employee) {//->instanceof : type비교. ==과 같은 의미.앞에 거 타입이 (상속받은 클래스)랑 같니?변경가능하니?
		//Employee모든 정보 출력. 자식 객체 접근하려면 강제형변환!
